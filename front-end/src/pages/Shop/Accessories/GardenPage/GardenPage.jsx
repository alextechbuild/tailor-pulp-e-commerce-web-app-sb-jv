...
import { garden_imported_texts_list } from "../../../../utils/VerticalScrollingBoard/ImgWrappersTextsListUtils.js";




function GardenPage({VerticalScrollingBoardImgs}) {
    ...
    return (
        ...
        className="garden-page">
            ...
            className="garden-page-wrapper">
                ...
                <div 
                className="garden-page-maincontent">

                    <VerticalScrollingBoard VerticalScrollingBoardImgs={VerticalScrollingBoardImgs} imported_texts_list={garden_imported_texts_list}/>
