...
import { jewellery_imported_texts_list } from "../../../../utils/VerticalScrollingBoard/ImgWrappersTextsListUtils.js";




function JewelleryPage({VerticalScrollingBoardImgs}) {
    ...
    return (
        ...
        className="jewellery-page">
            ...
            <div 
            className="jewellery-page-wrapper">
                ...
                <div 
                className="jewellery-page-maincontent">

                    <VerticalScrollingBoard VerticalScrollingBoardImgs={VerticalScrollingBoardImgs} imported_texts_list={jewellery_imported_texts_list}/>
