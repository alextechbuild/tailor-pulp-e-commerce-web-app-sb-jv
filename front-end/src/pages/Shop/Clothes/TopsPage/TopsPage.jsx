...
import { tops_imported_texts_list } from "../../../../utils/VerticalScrollingBoard/ImgWrappersTextsListUtils.js";




function TopsPage({VerticalScrollingBoardImgs}) {
    ...
    return (
        ...
        className="tops-page">
            ...
            className="tops-page-wrapper">
                ...
                <div 
                className="tops-page-maincontent">

                    <VerticalScrollingBoard VerticalScrollingBoardImgs={VerticalScrollingBoardImgs} imported_texts_list={tops_imported_texts_list}/>
