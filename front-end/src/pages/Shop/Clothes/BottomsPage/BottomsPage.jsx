...
import { bottoms_imported_texts_list } from "../../../../utils/VerticalScrollingBoard/ImgWrappersTextsListUtils.js";




function BottomsPage({VerticalScrollingBoardImgs}) {
    ...
    return (
        ...
        <div 
        className="bottoms-page">

            <div 
            className="bottoms-page-wrapper">
                ...
                <div 
                className="bottoms-page-maincontent">

                    <VerticalScrollingBoard VerticalScrollingBoardImgs={VerticalScrollingBoardImgs} imported_texts_list={bottoms_imported_texts_list}/>
