...
import { hats_imported_texts_list } from "../../../../utils/VerticalScrollingBoard/ImgWrappersTextsListUtils.js";




function HatsPage({VerticalScrollingBoardImgs}) {
    ...
    return (
        ...
        className="hats-page">
            ...
            className="hats-page-wrapper">
                ...
                <div 
                className="hats-page-maincontent">

                    <VerticalScrollingBoard VerticalScrollingBoardImgs={VerticalScrollingBoardImgs} imported_texts_list={hats_imported_texts_list}/>
