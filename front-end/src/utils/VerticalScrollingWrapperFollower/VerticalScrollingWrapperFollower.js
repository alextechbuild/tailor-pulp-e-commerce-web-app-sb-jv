...
export const manage_vertical_scrolling_wrapper = (
    ...
    path_total_length, alternate_sense_value, tick, raf_id, path, follower, svg) => {
    ...
    if (!is_in_wrapper.obj) {
        ...
        if (progress.obj > 0 - path_total_length / 100 && progress.obj < path_total_length + path_total_length / 100) {
                ...
                raf_id.obj = requestAnimationFrame(() => {
                    ...
                    if (alternate_sense_value.obj === 1) {
                        ...
                        if (progress.obj < path_total_length) {
                            ...
                            progress.obj += (path_total_length / 100);
